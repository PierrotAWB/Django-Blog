"""
Django settings for django_test_site project.
...
SECRET_KEY = 'rn(klukvw!t6s*$5wg_cek*vp=1of_yif*ozb6)mp01u)d2(+4'
...
ROOT_URLCONF = 'django_test_site.urls'
...
WSGI_APPLICATION = 'django_test_site.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# Access login info with environment variables
